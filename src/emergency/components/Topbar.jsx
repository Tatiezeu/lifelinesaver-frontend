...
const defaultProfilePic = lifelineLogo;
    ...
    try {
      ...
      const profilePic = data.profile_picture
        ? data.profile_picture.startsWith("http")
          ...
          : `http://localhost:8080/LifelineJavaBackend${data.profile_picture}`
        : defaultProfilePic;
      ...
      if (storedPic) setProfilePicUrl(storedPic.startsWith("http") ? storedPic : `http://localhost:8080/LifelineJavaBackend${storedPic}`);
    }
  };
